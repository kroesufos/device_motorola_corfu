...
BOARD_KERNEL_CMDLINE := androidboot.usbcontroller=musb-hdrc bootopt=64S3,32N2,64N2 cgroup_disable=pressure loop.max_part=7 swiotlb=0 cgroup.memory=nokmem,nosocket androidboot.selinux=permissive bootopt=64S3,32N2,64N2 buildvariant=user
